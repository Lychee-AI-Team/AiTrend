...
// 主组件
const DailyNewsBalanced: React.FC = () => {
...
registerRoot(() => (
  <>
    <Composition
      id="DailyNewsBalanced"
      component={DailyNewsBalanced}
