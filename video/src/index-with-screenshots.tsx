...
const VIDEO_CONFIG = {
  fps: 30,
  totalFrames: 1542,  // 51.48秒 @ 30fps
  scenes: [
    {
      id: 'opening',
      type: 'opening',
      startFrame: 0,
      durationFrames: 144,  // 4.82秒
...
// 主组件
const DailyNewsWithScreenshots: React.FC = () => {
...
const HotspotScene: React.FC<any> = ({
  rank, title, chineseText, url, screenshot
}) => (
  <div style={{
    width: 1080,
    height: 1920,
...
registerRoot(() => (
  <>
    <Composition
      id="DailyNewsWithScreenshots"
      component={DailyNewsWithScreenshots}
