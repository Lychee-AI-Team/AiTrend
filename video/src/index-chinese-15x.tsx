...
const VIDEO_CONFIG = {
  fps: 30,
  totalFrames: 3303,  // 110.20秒 @ 30fps
  scenes: [
    {
      id: 'opening',
      type: 'opening',
      startFrame: 0,
      durationFrames: 157,  // 5.26秒
