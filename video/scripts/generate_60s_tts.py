...
print("=== 生成60秒版本TTS（正常语速1.0x）===\n")

total_duration = 0

for name, text in scripts.items():
    output = f'/home/ubuntu/.openclaw/workspace/AiTrend/video/assets/audio/2026-02-06/{name}_60s.mp3'
    print(f'生成 {name}_60s.mp3...')
