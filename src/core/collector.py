...
【强制过滤规则 - 必须遵守】
以下信息类型直接删除，不输出：
1. 官方新闻源内容（标记[官方新闻-低权重]的）
2. 公司官方发布（"XX公司发布/推出/宣布XX"）
3. 行业新闻报道（登上XX杂志、融资、市值、排名）
4. 纯模型参数对比（"XX战胜XX"、"超越GPT"等新闻）
5. 亲密度评分<15分的内容

【亲密度评分标准】
对每条信息按5个维度评分（1-5分）：
1. 可操作性：今天能否开始使用？（工具5分，新闻1分）
2. 决策影响：能否帮助做具体决策？（能5分，不能1分）
3. 使用门槛：5分钟能否上手？（能5分，需专业背景1分）
4. 个人收益：对个人有无直接提升？（有5分，无1分）
5. 时间收益：本周能否见效？（能5分，长期趋势1分）
